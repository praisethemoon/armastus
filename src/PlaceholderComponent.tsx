    ...
    render(){
        return (
            <Div key="placeholderRoot" style={{ width: "100%", height: "100%"}}>
                <TextBox style={{borderWidth: 10, borderColor: "#000000", backgroundColor: "#ffffff", width: 200, height: 200}} key="placeholderText" halign="center" valign="center" fontAssetName="defaultFont_30">{this.props.message}</TextBox> 
                {...this.children}
